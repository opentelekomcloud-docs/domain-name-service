...
otcdocs_repo_name = 'opentelekomcloud-docs/domain-name-service'
# Those variables are required for edit/bug links

# Those variables are needed for indexing into OpenSearch
otcdocs_doc_environment = 'public'
otcdocs_doc_link = '/domain-name-service/umn/'
otcdocs_doc_title = 'User Guide'
otcdocs_doc_type = 'umn'
otcdocs_service_category = 'network'
otcdocs_service_title = 'Domain Name Service'
otcdocs_service_type = 'dns'
...
html_title = "Domain Name Service - User Guide"
...
latex_documents = [
    ('index',
     'dns-umn.tex',
    u'Domain Name Service - User Guide',
